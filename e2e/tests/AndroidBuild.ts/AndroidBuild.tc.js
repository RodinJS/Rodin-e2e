...
describe('AndroidBuild.ts', () => {
    ...
    it('Create_project_with_unique_URL.tc', () => {
    	...
    	globalFunc.createProject('Basic', 'AndroidProj1', 'Androidurl1','Android project 1 description', "", true);

    	// create a new project for Android Build   	
    	globalFunc.createProject("Drag'n'Drop", 'AndroidProj2', 'Androidurl2','Android project 2 description', "", true);
