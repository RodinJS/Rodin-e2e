...
describe('iOSBuild.ts', () => {
    ...
    it('Empty_bundle_identifier.tc', () => {
        ...
        // fill all iOS fields
        iOSCommon.iOSFieldsFill("iOSApp", "1.1.1", "", "TestDev", mobile_prov, cert, icon);
        ...
        // checking that error appeared that application bundle is not specified
