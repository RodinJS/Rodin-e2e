...
describe('EditProfile.ts', () => {
    ...
    it('changeFirstName.tc', () => {

        // go to edit profile section
        globalFunc.openEditProfile();
       
       	// set user's first name
        objMap.lastName.sendKeys('VRovich');

        // check last name's value
        expect(objMap.lastName.getAttribute('value')).toEqual('VRovich');
    ...
    it('Cleanup.tc', () => {
        ...
        // clear first name
        objMap.lastName.clear();

        // check last name's value
        expect(objMap.lastName.getAttribute('value')).toEqual('');
