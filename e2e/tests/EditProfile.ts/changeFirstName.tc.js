...
describe('EditProfile.ts', () => {
    ...
    it('changeFirstName.tc', () => {
        ...
        objMap.firstName.sendKeys('Rodin');

        // check last name's value
        expect(objMap.firstName.getAttribute('value')).toEqual('Rodin');
    ...
    it('Cleanup.tc', () => {
        ...
        // clear first name
        objMap.firstName.clear();

        // check last name's value
        expect(objMap.firstName.getAttribute('value')).toEqual('');
