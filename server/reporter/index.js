...
var HTMLReport = function () {
    ...
    var generateSummaries = function (reportXml, report) {
        ...
        for (var i = 0; i < totalSuites; i++) {
            ...
            suitesData.push({
                ...
                'testcasestimes': testCasesTimes,
                'testcasesmessages': testCasesMessages,
                'screenshotsNames': screenshotsNamesOnFailure,
                'tests': suite.tests,
                'failed': suite.failed,
                'errors': suite.errors,
    ...
    this.from = function (reportXml, testConfig) {
        ...
        report.browserLog = testConfig.browserLog || 'No browser Log';
